  ...
  return (
    <div className="container">
      ...
      <main>
        ...
        <p>I'll also talk in detail about the pros and cons of DIY v. professional installation. If you have a question not covered on the page, use the "question" box below to send me a question. I'll try to get back to you within one business day.</p>
        
        <h2>Table Of Contents</h2>
        <ul>
          <li className="show"><a href="#Choosing_The_Right_Type_Of_Mirror_Tile">Choosing The Right Type Of Mirror Tile</a></li>
          <li className="show"><a href="#Communicating_Your_Ideas_And_Receiving_Bids">Communicating Your Ideas And Receiving Bids</a></li>
          <li className="show"><a href="#Considerations:_DIY_Vs._Professional">Considerations: DIY Vs. Professional</a></li>
          <li className="show"><a href="#DIY_Techniques_And_Considerations_(separate_These)">DIY Techniques And Considerations (separate These)</a></li>
          <li className="show"><a href="#Cleaning_And_Maintenance">Cleaning And Maintenance</a></li>
          <li className="show"><a href="#Durability_Replacements_Glass_Cracking_From_Heat">Durability Replacements Glass Cracking From Heat</a></li>
          <li className="show"><a href="#Alternatives_That_Achieve_A_Similar_Look">Alternatives That Achieve A Similar Look</a></li>
        </ul>
        
        <h2>Some Things To Consider About Mirror Tiles</h2>
        <div style={{ backgroundColor: '#e0f7fa', color: '#006064', padding: '40px 20px', marginBottom: '40px', borderRadius: '8px' }}>
          ...
          <ul style={{ listStyleType: 'none', padding: 0 }}>
            <li style={{ fontSize: '20px', lineHeight: 1.6, marginBottom: '16px', position: 'relative', paddingLeft: '25px' }}>
            ...
            <li style={{ fontSize: '20px', lineHeight: 1.6, position: 'relative', paddingLeft: '25px' }}>
              <span style={{ position: 'absolute', left: 0, top: 0 }}>&#9679;</span>
        ...
        <figure style={{ textAlign: 'center' }}>
          ...
          <figcaption className="cap">a classic case of mirror distortion...</figcaption>
        </figure>
        <br />
      </main>
    </div>
